...
app.config['SQLALCHEMY_DATABASE_URI'] = '<INSERT YOU DATA BASE URL>'
app.config['SQLALCHEMY_POOL_RECYCLE'] = 299
app.config['SQLALCHEMY_POOL_TIMEOUT'] = 20
db = SQLAlchemy(app)

user = "<ADD SVN USERNAME HERE>"
...
def show_team_commits():
	...
	return render_template('team-commits.html', user=user, commits=commits, months_categories=months_categories, events=events)
